...
const HomePage = lazy(() =>
  import('@sampo-forge/home').then((m) => ({ default: m.HomePage })),
)
const ProxyToolkit = lazy(() =>
  import('@sampo-forge/proxy-toolkit').then((m) => ({ default: m.ProxyToolkit })),
)
const AwgQrGenerator = lazy(() =>
  import('@sampo-forge/awg-qr-generator').then((m) => ({ default: m.AwgQrGenerator })),
)
const AwgConfigGenerator = lazy(() =>
  import('@sampo-forge/awg-config-generator').then((m) => ({
    default: m.AwgConfigGenerator,
  })),
)
const MihomoConfigGenerator = lazy(() =>
  import('@sampo-forge/mihomo-config-generator').then((m) => ({
