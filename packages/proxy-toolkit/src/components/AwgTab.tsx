...
import {
  ...
  esc,
  type AmneziaConfig,
} from '@sampo-forge/shared/lib/amnezia-config'
import { makeQR } from '@sampo-forge/shared/lib/qr'
import { useTranslation } from '@sampo-forge/shared/i18n/useTranslation'
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@sampo-forge/shared/ui/tabs'
...
import { Separator } from '@sampo-forge/shared/ui/separator'
