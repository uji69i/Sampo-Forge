...
import { normalizeManualRule } from '@sampo-forge/shared/lib/mihomo/validators'
import type { ManualRule, ManualRuleType } from '@sampo-forge/shared/lib/mihomo/types'
